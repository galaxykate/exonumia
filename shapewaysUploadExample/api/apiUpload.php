...
try {  
  // $filename = "mycoin.obj";
  // $file = file_get_contents("../3dmodel/". $filename);
  $filename = $modelFileName;
  $file = file_get_contents($modelFilePath. $filename);
  ...
  echo "ERROR: Call to API failed: " . $exception->getMessage(), "Model File Path: " + $modelFilePath;
}