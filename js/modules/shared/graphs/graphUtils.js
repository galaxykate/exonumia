...
define([prefix + "edge", prefix + "graph", prefix + "path", prefix + "svgLoader", prefix + "voronoiGraph"], function(Edge, Graph, Path, SVG, voronoiGraph) {
    Graph.Path = Path;
    ...
    Graph.createVoronoiGraph = voronoiGraph.createVoronoiGraph;
    _.extend(Graph, SVG);
    return Graph;
